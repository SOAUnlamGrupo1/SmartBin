...
void display()
{
	...
	switch(evento.tipo)
	{
		...
		case(TIPO_EVENTO_TAPA_ABIERTA):
		{
			...
			strcpy(settings_data,"LIQUIDO|NO\r");				
			BT.write(settings_data);
			
			memset(settings_data, 0, sizeof(settings_data));
			
			strcpy(settings_data,"ABIERTO|SI\r");				
			BT.write(settings_data);
			
			memset(settings_data, 0, sizeof(settings_data));
			
			strcpy(settings_data,"MANTENIMIENTO|NO\r");				
			BT.write(settings_data);
			
			memset(settings_data, 0, sizeof(settings_data));
			
			strcpy(settings_data,"LLENO|NO\r");				
			BT.write(settings_data);
		...
		case(TIPO_EVENTO_TAPA_CERRADA):
		{
			...
			strcpy(settings_data,"ABIERTO|NO\r");				
			BT.write(settings_data);
		...
		case(TIPO_EVENTO_CAPACIDAD_TACHO_LLENO):
		{
			...
			strcpy(settings_data,"MANTENIMIENTO|SI\r");				
			BT.write(settings_data);
			
			memset(settings_data, 0, sizeof(settings_data));
			
			strcpy(settings_data,"LLENO|SI\r");				
			BT.write(settings_data);
		...
		case(TIPO_EVENTO_HAY_AGUA):
		{
			...
			char settings_data[100];
			strcpy(settings_data,"LIQUIDO|SI\r");				
			BT.write(settings_data);
